...
<div class="content">
	...
	?>
			...
			<table width="100%">
			<tr>
			<td align="left" width="400px"><?php echo '<img src="admin/includes/img/'.$img.'" height="280px" width="350px">';?></td>
            ...
            <table width="75%" align="center"> <tr align=""><td width ="" height="200" align="center">
                  <?php if(!isset($_SESSION['userid'])){
     						echo "You need to login to see this news.";
							echo '<a href="index.php?page=Login"> Click here </a> to Log In.';
				  			}
						if (isset($_SESSION['userid'])){
				  ?>
                    <b>Description<br /></b><?php echo '<font color="#AE4F09">'.$des.'</font>'; ?><br /></font><?php }?>
            </td></tr></table> 
