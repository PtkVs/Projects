...
<td width="50%"> 
	<form action="DisplayAllNews.php">
    ...
    <select name="category" >
        ...
        <td align="left"><input name="search" type="text" placeholder="Field Data"/>
...
$j = 1;
	...
	if($affrows > 0){
		  ...
		  for($i = 1; $rows= mysql_fetch_assoc($sql); $i++) 
		  {
			...
			echo '<td width="100px"> 
			  		<td><img src="admin/includes/img/'.$img.'" height="120px" width="200px"></td>';
