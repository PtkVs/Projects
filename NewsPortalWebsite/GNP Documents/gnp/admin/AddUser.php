	 <form method="post" action="index.php?page=AddUser" enctype="multipart/form-data">
	   ...
	   $query="insert into table_users(Name, Address, Username, Password, Email,Usertype) values('".$name."', '".$address."', '".$username."'	, '".$password."', '".$email."', '".$utype."')";
