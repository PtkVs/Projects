...
<form method="post" action="AddHelp.php" enctype="multipart/form-data">
	   ...
	   $query="insert into table_help (Help) values('".$description."') ";
	   ...
	   $result = mysql_query($query) or trigger_error("There was some error in the sql statement" . mysql_error());
	    	...
	    	$affrows = mysql_affected_rows($conn);
								if($affrows > 0)
								{
									...
									echo '<center><font color="Grey"><b>Help Description entry successful. Thank you.</b></font></center>';								
								}
